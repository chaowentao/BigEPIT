...
parser.add_argument(
    "--use_pre_ckpt", type=bool, default=True, help="use pre model ckpt"
)
parser.add_argument(
    "--path_pre_pth",
    type=str,
    default="./pretrained_model/RR_HLFSR_4xSR_5x5.pth.tar",
...
parser.add_argument(
    "--n_blocks", type=int, default=15, help="number of SRBs blocks in one HFEM"
)
...
parser.add_argument(
    ...
    type=int,
    default=1,
    help="cropped test method( 1- whole image| 2- cropped mxn patches | 3- cropped 4 patches",
)
...
parser.add_argument(
    ...
    type=int,
    default=0,
    help="disable calculate PSNR/SSIM since there is no ground truth image",
)
